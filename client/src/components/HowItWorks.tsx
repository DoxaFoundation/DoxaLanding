...
const steps = [
  {
    ...
    description: "You deposit collateral (ICP, ckBTC, ckETH) into the protocol.",
  },
  {
    number: 2,
    title: "Reserve Pool",
    description: "Collateral is converted to ckUSDC and locked securely in the protocol.",
  },
  {
    number: 3,
    title: "DoxaUSD (USDx)",
    description: "USDx is instantly minted and sent to your wallet, ready to use.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-heading font-bold">
            <span className="inline-block border-b-2 border-white pb-1">How It Works</span>
          </h2>
          <p className="mt-4 text-xl text-gray-300">One protocol. Three core canisters.</p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <AnimatedSection 
              ...
              className="relative"
            >
              <div className="absolute -left-4 top-0 text-9xl font-bold opacity-10">{step.number}</div>
        ...
        <AnimatedSection className="mt-16 p-8 rounded-2xl border border-white/10 bg-gradient-to-r from-white/5 to-black/20" delay={0.4}>
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              <h3 className="text-2xl font-semibold mb-4">And the peg?</h3>
              <p className="text-lg text-gray-300">Maintained 24/7 by an intelligent ckUSDC pool.</p>
              ...
              <p className="mt-6 font-medium italic">You deserve to see what backs your money. With Doxa, you do.</p>
            </div>
