          ...
          <AnimatedSection className="space-y-8" delay={0.1}>
            ...
            >
              ...
              <div className="relative group">
                <span className="inline-block bg-gradient-to-r from-white to-white bg-clip-text text-transparent">Stablecoins</span>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mt-6">
              Create, own and earn with a multi-stablecoin platform with the Doxa USD.
            </p>
            
            <div className="border border-white/20 rounded-lg p-5 backdrop-blur-sm bg-white/5">
              <p className="font-medium">No banks. No middlemen. No central point of failure.</p>
              <p className="text-gray-400 mt-2">Just programmable money—backed, secure, fast.</p>
            </div>
